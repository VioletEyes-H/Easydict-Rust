    ...
    <template #config>
      <div class="niutrans-config">
        ...
        <div class="config-hint">
          <a-typography-link href="https://niutrans.com" target="_blank">
            <LinkOutlined/> 小牛翻译
          </a-typography-link>
        </div>
      </div>
...
import {fetchNiuTransTranslate} from './niutrans-api.js'
...
async function verify() {
  ...
  try {
    await fetchNiuTransTranslate('hello', 'en', 'zh', form.apiKey)
...
async function translate(e) {
  ...
  try {
    const result = await fetchNiuTransTranslate(input, sourceLang, targetLang, form.apiKey, signal)
    ...
    console.error('[NiuTransService] translate error:', err)
